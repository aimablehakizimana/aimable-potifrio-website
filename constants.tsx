...
export const INITIAL_PROJECTS: ProjectType[] = [
  {
    ...
    imageUrl: 'https://picsum.photos/seed/portfolio/400/300', // Placeholder, project images are uploaded
...
export const DEFAULT_PROFILE_PIC = '/images/hhh.jpg'; // Updated to point to the new static image
