...
// Path to the static profile picture.
// IMPORTANT: Ensure the image file 'hhh.jpg' exists in the 'public/images/' directory.
export const STATIC_PROFILE_PIC_URL = '/images/hhh.jpg';
